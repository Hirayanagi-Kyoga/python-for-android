...
class KivyRecipe(CythonRecipe):
    version = '2.3.0'
    url = 'https://github.com/Hirayanagi-Kyoga/python-for-android/kivy/archive/{version}.zip'
    name = 'kivy'
    ...
    # See: https://github.com/Hirayanagi-Kyoga/python-for-android/kivy/pull/8025
